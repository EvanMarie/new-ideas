        ...
        <DarkFlexFull>
          <VStackFull gap="gap-2vh" className={darkFlexInnerPadding}>
            ...
            <Text className="textFogXxs">
              ...
              practical, elegant, and intelligent web solutions, with a focus on
          ...
          <VStackFull className={darkFlexInnerPadding}>
            <VStackFull gap="gap-[2vh]" className="h-fit" align="items-start">
              <Text className="textFogXxs">
                ...
                development and AI implementation is crucial. Our comprehensive
                approach ensures each project excels in aesthetics,
