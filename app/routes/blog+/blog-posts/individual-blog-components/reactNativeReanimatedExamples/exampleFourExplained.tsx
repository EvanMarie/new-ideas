...
export function ExampleFourExplained() {
  return (
    <CenterHorizontalFull className="lg:px-[1vh] pt-[2vh]">
      <Flex className="bg-slate-900 border-900-md shadowBroadNormal px-[1vh] py-[2vh] gap-[2vh] flex-col">
        ...
        <Text className={paragraphTextSize}>
          ...
          This component allows an element to be dragged around the screen and
          flung with a decay animation when released. Here’s a detailed
        ...
        <Text className={paragraphTextSize}>
          <ul className="list-disc pl-5">
            ...
            <li className={paragraphTextSize}>
              <strong>Decay Animation:</strong> The{" "}
              <code className={paragraphTextSize}>withDecay</code> function is
              used to animate the shared values with a decay effect, providing a
    ...
    offsetY.value = withDecay({
      ...
      deceleration: 0.998,
              ...
              <ul className="list-disc pl-5">
                ...
                <li className={paragraphTextSize}>
                  <strong>onEnd:</strong> Animates the element with a decay
                  effect based on the gesture's velocity.
                </li>
              </ul>
            </li>
            <li className={paragraphTextSize}>
      ...
      <GestureDetector gesture={gesture}>
        ...
        >
          <TextXs style={{ textAlign: "center", fontWeight: 600 }}>Fling Me</TextXs>
              ...
              the element indicates that it can be flung.
            </li>
          </ul>
        </Text>
      </Flex>
